export const TARGETS = {
            anxious_parents: {
                ...
                techniqueReasons: {
                    ...
                    scientific_veneer: '科学的な数字には一定の信頼を置きますが、内容の精査よりも結論を重視する傾向があります。',
                    cherry_picking: '極端な主張には警戒心を持つことが多く、子供のために慎重な判断をしようとします。',
                    social_proof: '「みんながやっている」より「我が子に本当に必要か」を重視するため、流行には流されにくいです。'
                }
            },
            youth: {
                id: 'youth',
                ...
                traits: '社会的証明に弱く、権威訴求には懐疑的',
                weaknesses: ['social_proof', 'cherry_picking'],
                ...
                techniqueReasons: {
                    ...
                    scientific_veneer: '数字やデータには一定の関心がありますが、深く検証するより直感で判断する傾向があります。',
                    cherry_picking: 'SNSで「どちら側か」を明確にする文化に慣れており、対立構造に引き込まれやすいです。仲間意識を刺激されると反応します。',
                    social_proof: 'トレンドに敏感で、「乗り遅れたくない」という気持ちが強いです。インフルエンサーや友人の行動に影響されやすいです。'
                }
            },
            elderly: {
                id: 'elderly',
                ...
                weaknesses: ['authority', 'scientific_veneer'],
                resistances: ['social_proof'],
                techniqueReasons: {
                    ...
                    scientific_veneer: '科学的なデータや数字を「きちんとした研究」と捉えやすく、サンプル数や調査方法の問題点に気づきにくいです。',
                    cherry_picking: '社会経験から極端な主張には警戒心を持つことが多いですが、「正義」を強調されると揺らぐことも。',
                    social_proof: '「若者の流行」には関心が薄く、自分には関係ないと感じることが多いです。'
                }
            }
        };
